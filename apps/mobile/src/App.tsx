...
export default function App() {
  ...
  if (!approved) {
    return <main className="login-shell"><section className="login-card">
      ...
      <div className="brand-mark">W</div><p className="eyebrow">MADE BY POOJAK DOSHI</p><h1>Website Maker AI</h1><p className="muted">Approved users sign in with an email OTP.</p>
  ...
  return <main className="app-shell">
    ...
    <footer>Website Maker AI · Made by Poojak Doshi</footer>
  </main>;
}
